...
const Static = () => {
    ...
    const [leftNavType, setLeftNavType] = useState(true)
    ...
    return (
        <>
            <div className={leftNav ? 'g-sidenav-show g-sidenav-pinned' : 'g-sidenav-show'}>
                <aside
                    className={leftNavType
                        ? 'sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y bg-white'
                        : 'sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps ps--active-y bg-transparent'
                    }
                    data-color={navColor}
                >
                    <div className='sidenav-header'>
                        <Link to='/' className='navbar-brand m-0' >
                            {/* <img src='https://e1.yotools.net/images/user_image/2022/04/626039b63e731.jpg' className='navbar-brand-img h-100' alt='main_logo' /> */}
                            <span className='text-lg font-weight-bold d-flex justify-content-center'><i className='fa fa-music'> Music App</i></span>
                        </Link>
                    </div>
                    <hr className='horizontal dark mt-0' />
                    <div className='collapse navbar-collapse w-auto navbar-collapse-height'>
                        <ul className='navbar-nav'>
                            ...
                            <li className='nav-item'>
                                ...
                                >
                                    <div className='icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center'>
                                        <i className='fa fa-headphones text-dark text-sm'></i>
                                    </div>
                                    <span className='nav-link-text ms-1'>Playlists</span>
                                </NavLink>
                            </li>
                            <li className='nav-item'>
                                <NavLink
                                ...
                                >
                                    ...
                                    <span className='nav-link-text ms-1'>Albums</span>
                                </NavLink>
                            </li>
                            {dataUser && (
                                <li className='nav-item'>
                                    ...
                                    >
                                        <div className='icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center'>
                                            <i className='fa fa-telegram text-dark text-sm'></i>
                                        </div>
                                        <span className='nav-link-text ms-1'>Manager</span>
                                    </NavLink>
                                </li>
                            )}
                            ...
                            {dataUser && dataUser.role === 10 && (
                                <li className='nav-item'>
                                    ...
                                    >
                                        ...
                                        <span className='nav-link-text ms-1'><b style={{ color: 'red' }}>Admin Panel</b></span>
                                    </NavLink>
                                </li>
                            )}
                                ...
                                ? (
                                    <>
                                        ...
                                        <li className='nav-item'>
                                            ...
                                            >
                                                <div className='icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center'>
                                                    <i className='fa fa-key text-dark text-sm'></i>
                                                </div>
                                        ...
                                        <li className='nav-item'>
                                            ...
                                            >
                                                <div className='icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center'>
                                                    <i className='fa fa-sign-out text-dark text-sm'></i>
                                                </div>
                                ...
                                : (
                                    <>
                                        ...
                                        <li className='nav-item'>
                                            ...
                                            >
                                                <div className='icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center'>
                                                    <i className='fa fa-lock text-dark text-sm'></i>
                                                </div>
                ...
                <main className='main-content position-relative h-100 border-radius-lg '>
                    ...
                    <nav
                        className={navBarFixed
                            ? 'navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky'
                    ...
                    >
                        <div className='container-fluid py-1 px-3'>
                            <nav aria-label='breadcrumb'>
                                ...
                                {/* <h6 className='font-weight-bolder mb-0 static-title-hide'>Dashboard</h6> */}
                                <div className='header-control font-weight-bolder mb-0 static-title-hide'>
                                    <i
                                        onClick={() => navigate(-1)}
                                        className='fa fa-arrow-left cursor-pointer previous'
                                    ></i>
                                    <i
                                        onClick={() => navigate(1)}
                                        className='fa fa-arrow-right cursor-pointer next'
                                    ></i>
                                ...
                                <ul className='navbar-nav  justify-content-end'>
                                    <li className='nav-item d-flex align-items-center'>
                                        {!dataUser
                                            ...
                                            : (
                                                <Link to='user' className='nav-link text-body font-weight-bold px-0 static-user-avatar'>
                                    ...
                                    <li className='nav-item d-xl-none ps-3 d-flex align-items-center'>
                                        <div
                                            ...
                                            className='nav-link text-body p-0 cursor-pointer' id='iconNavbarSidenav'
                                        >
            ...
            <div className={rightNav ? 'fixed-plugin show' : 'fixed-plugin'}>
                <div className='card shadow-lg '>
                    ...
                    <div className='card-body pt-sm-3 pt-0'>
                        ...
                        <Link to='' className='switch-trigger background-color'>
                            <div className='badge-colors my-2 text-start'>
                                <span
                                    ...
                                    className={navColor === 'primary' ? 'badge filter bg-gradient-primary active' : 'badge filter bg-gradient-primary'}
                                    data-color='primary' ></span>
                                <span
                                    onClick={() => setNavColor('dark')}
                                    className={navColor === 'dark' ? 'badge filter bg-gradient-dark active' : 'badge filter bg-gradient-dark'}
                                    data-color='dark' ></span>
                                <span
                                    onClick={() => setNavColor('info')}
                                    className={navColor === 'info' ? 'badge filter bg-gradient-info active' : 'badge filter bg-gradient-info'}
                                    data-color='info' ></span>
                                <span
                                    onClick={() => setNavColor('success')}
                                    className={navColor === 'success' ? 'badge filter bg-gradient-success active' : 'badge filter bg-gradient-success'}
                                    data-color='success' ></span>
                                <span
                                    onClick={() => setNavColor('warning')}
                                    className={navColor === 'warning' ? 'badge filter bg-gradient-warning active' : 'badge filter bg-gradient-warning'}
                                    data-color='warning' ></span>
                                <span
                                    onClick={() => setNavColor('danger')}
                                    className={navColor === 'danger' ? 'badge filter bg-gradient-danger active' : 'badge filter bg-gradient-danger'}
                        ...
                        <div className='d-flex'>
                            <div
                                onClick={() => setLeftNavType(!leftNavType)}
                                className={!leftNavType
                                    ? 'btn bg-gradient-primary w-100 px-3 mb-2 active'
                                    : 'btn bg-gradient-primary w-100 px-3 mb-2'
                                }
                            >Transparent</div>
                            <div
                                onClick={() => setLeftNavType(!leftNavType)}
                                className={leftNavType
                                    ? 'btn bg-gradient-primary w-100 px-3 mb-2 ms-2 active'
                                    : 'btn bg-gradient-primary w-100 px-3 mb-2 ms-2'
                                }
                            >White</div>
                        </div>
                        ...
                        <div className='w-100 text-center'>
                            <h6 className='mt-3'>Copyright 2022 @ <b>qnp</b></h6>
                            <Link to='' className='btn btn-dark mb-0 me-2' >
                                <i className='fab fa-facebook-square me-1' aria-hidden='true'></i> qnp
                            </Link>
                        </div>
                    </div>
                </div>
