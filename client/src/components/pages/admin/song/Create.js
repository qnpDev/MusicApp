...
const AdminCreateSong = () => {
    document.title = 'Upload new song | Admin'
            ...
            <div className='card mb-4'>
                <div className='card-header'>
                    <div className='d-flex align-items-center'>
                        <h6 className='mb-0 fw-bolder'>Upload new song | Admin</h6>
                    </div>
                </div>
...
export default AdminCreateSong;